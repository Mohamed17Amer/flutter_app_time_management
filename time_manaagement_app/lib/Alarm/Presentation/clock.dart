...
typedef APIndex = void Function(int);
...
class CustomTimePickerSpinner extends StatefulWidget {
  ...
  final APIndex? apIndex;

  const CustomTimePickerSpinner({super.key, 
   // Key? key,
    this.time,
  ...
  @override
  _CustomTimePickerSpinnerState createState() =>
          ...
          if (scrollNotification.direction.toString() ==
            ...
            setState(() {
              ...
              if (widget.onTimeChange != null) {
                ...
                // widget.apIndex!(currentSelectedAPIndex);
              }
            });
          }
